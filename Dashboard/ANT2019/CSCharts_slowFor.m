...
inputBase = '/Users/giulio.giorgione/Documents/Carsharing/test/output/org/matsim/contrib/carsharing/runExample/RunCarsharingIT/test/';
...
for I=1:ITERS
    ...
    %Retrieves data from the .txt file and puts it in a rectangular matrix
    TLP = strcat(num2str(I),'/run1.',num2str(I),'.CS.txt');     %file name = 'myfile01.txt'�
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'_Trip Length by PersonID.png'));
end
...
for I=1:ITERS %ITERS
    ...
    %Retrieves data from the .txt file and puts it in a rectangular matrix
    TLC = strcat(num2str(I),'/run1.',num2str(I),'.CS.txt'); %file name = 'myfile01.txt' 
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'_Trip Length by Car.png'));
end
...
for I=1:ITERS
    %Retrieves data from the .txt file and puts it in a rectangular matrix
    T2S = strcat(num2str(I),'/run1.',num2str(I),'.CS.txt'); %file name = 'myfile01.txt' 
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'_Time to Reach the Station.png'));
end
...
for I=1:ITERS
    ...
    %Retrieves data from the .txt file and puts it in a rectangular matrix
    DTP = strcat(num2str(I),'/run1.',num2str(I),'.CS.txt'); %file name = 'myfile01.txt' 
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Driving Time [%].png'));
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Booking Time [%].png'));
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Total Driving+Booking [%].png'));
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Total Driving+Booking [s].png'));  
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Total Driving Time [s].png'));
    ...
    %Plot Printing
    saveas(gcf,strcat(input,num2str(I),'Total Booking Time [s].png'));
