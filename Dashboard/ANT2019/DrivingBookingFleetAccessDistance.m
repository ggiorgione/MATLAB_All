...
%     inputBaseITER = strcat(inputBase,'ITERS/it.');
    ...
    input = strcat(inputBaseITER,DTP);                      %merge 2 or more strings
    delimiterIn = ",";
    StartingTime = readtable(input,'Delimiter',',');
    StartingTime.Var2=[];
    StartingTime.Var5=[];
    StartingTime.Var6=[];
    StartingTime.Var7=[];
    ...
    StartingTime = StartingTime(:,[2]); %Caring only about the inVehicleTime (5) and the vehicleId (8)
    ...
    save(filename,'BookingTimePercentage','BookingTime');
    ...
    if y==1
        ...
        if y==2
            ...
            if y==3
                ...
                VOT_ID_AccessTime = VOT_ID_AccessTime';
                VOT_ID_AccessTime = sortrows(VOT_ID_AccessTime,'ascend');
                VOT_ID_AccessTime = VOT_ID_AccessTime(1:numel(AccessTime3(:,1)),:);            AccessTime3_VOT = [AccessTime3 VOT_ID_AccessTime(:,2)];                   %Put them together
                ...
                if y==4
                    ...
                    if y==5
                        ...
                        if y==6
                            ...
                            VOT_ID_AccessTime = VOT_ID_AccessTime';
                            VOT_ID_AccessTime = sortrows(VOT_ID_AccessTime,'ascend');
                            VOT_ID_AccessTime = VOT_ID_AccessTime(1:numel(AccessTime6(:,1)),:);               %Put them together
                            ...
                            if y==7
                                ...
                                if y==8
                                    ...
                                    if y==9
                                        ...
                                        VOT_ID_AccessTime = VOT_ID_AccessTime';
                                        VOT_ID_AccessTime = sortrows(VOT_ID_AccessTime,'ascend');
                                        VOT_ID_AccessTime = VOT_ID_AccessTime(1:numel(AccessTime9(:,1)),:);                     %Put them together
                                        ...
                                        if y==10
                                            ...
                                            if y==11
                                                ...
                                                VOT_ID_AccessTime = VOT_ID_AccessTime';
                                                VOT_ID_AccessTime = sortrows(VOT_ID_AccessTime,'ascend');
                                                VOT_ID_AccessTime = VOT_ID_AccessTime(1:numel(AccessTime11(:,1)),:);            
                                                ...
                                                if y==12
                                                    ...
                                                    VOT_ID_AccessTime = VOT_ID_AccessTime';
                                                    VOT_ID_AccessTime = sortrows(VOT_ID_AccessTime,'ascend');
                                                    VOT_ID_AccessTime = VOT_ID_AccessTime(1:numel(AccessTime12(:,1)),:);                                                                                  %remove if "Dimensions of arrays being concatenated are not consistent."
